# 🎂 Interactive Birthday Surprise - Diya & Drashti

A fully functional, cute, and aesthetic interactive birthday website built with **Next.js**, **Tailwind CSS**, and **GSAP**.
...
- **Icons:** Lucide React
- **Fonts:** Inter & Handlee (via Google Fonts)

## 🎨 Aesthetic
The site uses a carefully selected pastel color palette:
- **Pink:** `#FFD1DC`
- **Lavender:** `#E6E6FA`
- **Blue:** `#AEC6CF`
- **Yellow:** `#FFF9E3`
